(() => {
    ...
    <div class="modal-content">
        ...
        <header class="header header-modal hidden-print">
            <div class="container modal-contaier">
                <h1 class="modal-city">Ваш город: </h1>
                 <ul class="header-info">
                <li>Сайт для проектировщиков</li>
                <li>Личный кабинет</li>
                <li><span class="header-info_change">Смена темы</span></li>
            </ul>
                <button id="themeToggleBtn" class="theme_change" aria-label="Сменить тему">
                    <img id="themeIcon" class="theme-icon change-icon" src="/img/light_lamp.svg"
                        data-light="/img/light_lamp.svg" data-dark="/img/dark_lamp.svg" width="90" alt="Иконка темы" />
                </button>
